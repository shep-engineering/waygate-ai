...
from limen.exceptions import ConfigError, RateLimitError, TransientError
from limen.security import DEFAULT_CANARY, apply_canary, check_response
...
class LLMClient:
    ...
    def call(
        ...
        Raises:
            ...
            LimenError:  Base class for mapped provider failures.
        """
